---
title: "[ditt kandidatnummer]sok_2008_h23_utf1"
format: html
editor: visual
---
...
```{r fig.asp = 0.5, fig.height=1, fig.width=10}
...
```{r fig.asp = 0.5, fig.height=1, fig.width=8}
df_raw %>%
  filter(statistikkvariabel == "Faktisk arbeidstid (timer per uke)", 
         år %in% c(1996, 2022),
         kjønn != "Begge kjønn") %>%
...
```{r fig.asp = 0.7, fig.height=1, fig.width=8}
